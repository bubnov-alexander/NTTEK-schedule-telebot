...
import datetime as dt, os.path, os, glob
...
def parserdef2(who, group):
    ...
    if num_files < par or num_files > par:
...
#Получаем сами расписания
        ...
        while a != par:
            if who == 'teacher':
                ...
                pari12 = ((" ".join(pari12)))
                dt_obj = (dt.datetime.strptime((pari12[:-1]),'%d.%m.%Y'))
                ...
                file = open(f'data/par{who}/{pari12}.txt', 'w', encoding='UTF-8')
